...
<div class="container">
    <h1>Admin Panel</h1>
    <p class="subtitle">Pregled sistema in hiter dostop do upravljanja podatkov</p>

    <ul>
        <li>Število uporabnikov: <strong><?= $stats["uporabniki"] ?></strong></li>
        <li>Število ekip: <strong><?= $stats["ekipe"] ?></strong></li>
        <li>Število igralcev: <strong><?= $stats["igralci"] ?></strong></li>
        <li>Število tekem: <strong><?= $stats["tekme"] ?></strong></li>
        <li>Število statistik: <strong><?= $stats["statistike"] ?></strong></li>
    </ul>
